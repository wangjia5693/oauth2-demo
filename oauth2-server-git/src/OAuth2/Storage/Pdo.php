    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    //根据oauth_clients表中的client_secret是否为空判断是否为公共
    ...
    //根据access_token获取access_token表中详情
    ...
    //根据access_token对access_token表进行插入更新
    ...
    //authorization表插入更新，可包括id_token
...
//插入refresh——code
    ...
    //根据username获取user表中数据，同时增加user_id字段
